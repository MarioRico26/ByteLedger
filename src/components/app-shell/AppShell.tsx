...
export default function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="app-shell-bg relative min-h-screen text-slate-900 print:bg-white">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(70%_55%_at_15%_-10%,rgba(37,99,235,0.2),transparent_60%)] print:hidden" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_50%_at_90%_10%,rgba(245,158,11,0.18),transparent_60%)] print:hidden" />
