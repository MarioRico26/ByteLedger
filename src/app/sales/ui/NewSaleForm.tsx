...
export default function NewSaleForm({
  ...
  function addLine() {
    setLines((prev) => [
      ...(prev ?? []),
      { productId: "", name: "", lineNote: "", showLineNote: false, type: "SERVICE", taxable: false, quantityStr: "1", unitPriceStr: "0.00" },
    ])
  }
  ...
  function pickProduct(idx: number, productId: string) {
    if (!productId) {
      updateLine(idx, { productId: "", type: "SERVICE", taxable: false, lineNote: "", showLineNote: false, unitPriceStr: "0.00" })
      return
    }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setDiscount("0.00")
      setTaxRate("0")
      setLines([{ productId: "", name: "", lineNote: "", showLineNote: false, type: "SERVICE", taxable: false, quantityStr: "1", unitPriceStr: "0.00" }])
